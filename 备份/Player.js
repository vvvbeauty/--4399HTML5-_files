...
Player.prototype.init = function()
{
    ...
    var scalex =  document.body.clientWidth/765;
	this.cannon = new ns.Cannon(ns.R.cannonTypes[power]);
	this.cannon.id = "cannon";
	this.cannon.x = (game.bottom.x + 425)*scalex;
	...
	this.cannonMinus.x = (game.bottom.x + 340)*scalex-20;
	...
	this.cannonPlus.x = this.cannonMinus.x + 140*scalex+16;
    ...
    //this.cannon.scaleX = document.body.clientWidth/765;
    //this.cannonMinus.scaleX = document.body.clientWidth/765;
    //this.cannonPlus.scaleX = document.body.clientWidth/765;

	this.coinNum = new ns.Num({id:"coinNum", src:ns.R.numBlack, max:6, gap:0, autoAddZero:true});
	this.coinNum.x = game.bottom.x + 8;
